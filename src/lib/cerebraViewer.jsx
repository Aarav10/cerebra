...
function BrainMesh() {
  const geometry = useMemo(() => {
    const geo = new THREE.SphereGeometry(1.1, 96, 96);
...
export default function BrainCanvas() {
  ...
  const processed = applyHeatmapToRegions(visibleRegions, heatmapMode);

  return (
    <Canvas
      dpr={[1, 2]}
      gl={{ antialias: true, toneMapping: 3, toneMappingExposure: 1.1 }}
      camera={{ position: [0, 0.5, 3.2], fov: 45, near: 0.1, far: 30 }}
    >
